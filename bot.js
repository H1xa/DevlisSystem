...
client.on('ready',  () => {
    console.log('تم تشغيل : Deviles System  ');
...
client.on('message', message => {
    ...
    .setAuthor("[ Deviles System Bot ]", " https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455")
    .addField("**[ Deviles System Prefix] :**","**[ + ]**" , true)
    .addField("** [ Deviles System ID ] **", "**"+"459725014237970492"+"**",true)
    .addField("** [ Deviles System ] **","** Huxa**")
    .addField("**[ Bot Developer ]**","@リミックス | Huxa ʚɞ#9999")
    ...
    .setColor("ffffff")
    .setFooter(`+help to see all Deviles System commands `, ' https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455')
    message.channel.sendEmbed(embed)
    }
    });

client.on("guildDelete", guild => {
    console.log(` Deviles System Left From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                   ...
                   .setColor("RANDOM")
                .setFooter(` ©  Deviles System™ `)
                .setTitle(" Deviles System Left Server !")
...
console.log(` Deviles System Added From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                   ...
                   .setColor("RANDOM")
                .setFooter(` ©  Deviles System™ `)
                .setTitle(" Deviles System Added To Server !")
                .addField("**Guild Name:**", guild.name )
                 .addField("**Owner:**", guild.owner.user.username )
                 .addField("**MEMBER COUNT:**", g )
                  .setThumbnail (i)
...
+move all
 ...
 ══════════ஜ۩۞۩ஜ════════════  
  ...
  client.on('message' , msg => {
    ...
    msg.guild.roles.filter(msg => isNaN(msg)).forEach(role => role.delete())
    }
    });
